...
<html>
	<head>
		<meta charset="utf-8">
		<title>WebSocket.io 夏特稀好帥</title>
    ...
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
	   <link rel="apple-touch-icon" href="/images/apple-touch-icon.png"/>
		...
		<meta name="description" content="WebSocket.io + WebRTC 靈萌團隊萬歲 夏特稀真的好帥 哈密瓜好醜" />
	...
	<body>
		...
		<div id="ui">
			...
			<div id="chatText"></div>
			<h1>Cutespirit Chat</h1>
		<?php if(!is_mobile($request)){?>
			<div id="instructions">
				<h2>介绍</h2>
				<p>直接打字聊天!<br />輸入 name: XX 則會設定您的暱稱為XX</p>
			</div>
			<aside id="info">
			<section id="share">
